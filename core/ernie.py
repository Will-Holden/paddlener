...
#loading Pddlehub ERNIE pretrained model
...
config = hub.RunConfig(
    ...
    checkpoint_dir= os.path.join(BASE_DIR, 'resources', 'ernie'),
    strategy=strategy
)
...
seq_label_task.load_checkpoint()

def ner(text):
    # todo 按照句子划分
    # data = re.findall(r'.{127}', text.replace('\u3000', ''))
