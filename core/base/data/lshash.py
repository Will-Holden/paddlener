...
from core.base.data.storage import storage
...
class LSHash(object):
    ...
    def __init__(self, hash_size, input_dim, num_hashtables=1,
                 storage_config=None, matrices_filename=None, overwrite=False, max_length=10000):
    ...
    def _init_hashtables(self):
        ...
        self.hash_tables = [storage(self.storage_config, i, self.max_length)
